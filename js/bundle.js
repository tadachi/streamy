...
/***/ function(module, exports, __webpack_require__) {
	...
	var GLOBALS = __webpack_require__(160);
	var Util = __webpack_require__(161);
	
	// Components
	var MainTwitchComponent = __webpack_require__(162);
	var TwitchVideoPlayer = __webpack_require__(168);
	var TwitchChat = __webpack_require__(169)
	...
	// detected that it's not a new window getting twitch oauth token so remove the preview parlor trick and show the actual app.
	    ...
	    TwitchVideoPlayerComponent = ReactDOM.render(
	        React.createElement(TwitchVideoPlayer, {div_id: "player"}),
	        document.getElementById('twitch_player')
	    );
	
	    TwitchChatComponent = ReactDOM.render(
	        React.createElement(TwitchChat, {parent_div_id: "twitch_chat"}),
	        document.getElementById('twitch_chat')
	    );
	
	    MainTwitchComponent = ReactDOM.render(
	        React.createElement(MainTwitchComponent, {
...
/***/ function(module, exports) {
	...
	Util.getQueryStringParams = function (sParam) {
	  ...
	  for (i = 0; i < sURLVariables.length; i++) {
	    if (sURLVariables[i].substring(0, 1) == "?") {
	      // Found query string.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TwitchAPI = __webpack_require__(163);
	var TypingDelay = __webpack_require__(161);
	
	// Lib
	var Util = __webpack_require__(161);
	
	// components
	var TwitchLoginButton = __webpack_require__(164);
	var SelectorForTwitchGames = __webpack_require__(165);
	var ListViewTwitchStreams = __webpack_require__(166);
	
	/*
	 * Component for twitch channel search.
	 */
	var MainTwitchComponent = React.createClass({displayName: "MainTwitchComponent",
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("div", {id: "search", style: search}, 
	                React.createElement("div", {style: flex_div}, 
	                    React.createElement(TwitchLoginButton, {style: login}), 
	                    ...
	                    React.createElement("b", {style: status}, this.state.status), 
	
	                    React.createElement("select", {style: select, ref: "selectInput", defaultValue: "TOPGAMES", onChange: this.selectCategoryHandle}, 
	                            React.createElement("option", {value: this.CATEGORIES.TOPGAMES}, this.CATEGORIES.TOPGAMES), 
	                            React.createElement("option", {value: this.CATEGORIES.SPEEDRUNS}, this.CATEGORIES.SPEEDRUNS), 
	                            React.createElement("option", {value: this.CATEGORIES.FOLLOWED}, this.CATEGORIES.FOLLOWED)
	                    )
	                ), 
	
	                React.createElement("div", {style: flex_button_area}, 
	                    React.createElement("button", {style: prev_button, onClick: this.showPrevGamesHandle}, "Prev"), 
	                    React.createElement("button", {style: button, onClick: this.showHideHandle}, "Show/Hide Games"), 
	                    React.createElement("button", {style: button, onClick: this.showNextGamesHandle}, "Next")
	                ), 
	
	                React.createElement(SelectorForTwitchGames, {style: game_list_view, selectGame: this.selectGame, data: this.state.games, display: this.state.games_display}), 
	                React.createElement(ListViewTwitchStreams, {style: streams_list_view, setChannel: this.setChannel, data: this.state.streams})
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	class TwitchAPI {
	    ...
	    authenticate() {
	        ...
	        var url = 'https://api.twitch.tv/kraken/oauth2/authorize' + '?response_type=token' + '&client_id={client_id}'.format({ client_id: client_id }) + '&redirect_uri={redirect_uri}'.format({ redirect_uri: redirect_uri }) + '&scope=user_read' + '&force_verify=true';
	    ...
	    getAuthToken() {
	        ...
	        if (access_token) return '{access_token}&scope={scope}'.format({ access_token: access_token, scope: scope });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TwitchLoginButton = React.createClass({displayName: "TwitchLoginButton",
	    ...
	    render: function() {
	        return (
	            React.createElement("img", {style: this.props.style, onClick: this.login, src: "http://ttv-api.s3.amazonaws.com/assets/connect_dark.png", href: "#"})
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectorForTwitchGames = React.createClass({displayName: "SelectorForTwitchGames",
	        ...
	        if (this.props.data) {
	                ...
	                if (this.props.data.top) {
	                    listView = this.props.data.top.map(function(top, i) {
	                        return (
	                            React.createElement("tbody", {style: tbody, key: i}, 
	                                React.createElement("tr", null, 
	                                    React.createElement("td", {style: logo, rowSpan: "2"}, 
	                                        React.createElement("img", {style: image, onClick: this.props.selectGame.bind(null, top.game.name), src: top.game.box.small})
	                                    ), 
	                                    React.createElement("td", {style: game_name, colSpan: "2"}, 
	                                        top.game.name
	                                    )
	                                ), 
	                                React.createElement("tr", null, 
	                                    React.createElement("td", {style: channels}, 
	                                        React.createElement("img", {style: icon, src: "assets/streamer_icon.png"}), 
	                                        top.channels
	                                    ), 
	                                    React.createElement("td", {style: viewers}, 
	                                        React.createElement("img", {style: icon, src: "assets/live_viewer_icon.png"}), 
	                                        top.viewers
	                                    )
	                                )
	                            )
	                    ...
	                    listView = this.props.data.games.map(function(game, i) {
	                        return (
	                            React.createElement("tbody", {style: tbody, key: i}, 
	                                React.createElement("tr", null, 
	                                    React.createElement("td", {style: logo}, 
	                                        React.createElement("img", {style: image, onClick: this.props.selectGame.bind(null, game.name), src: game.box.small})
	                                    ), 
	                                    React.createElement("td", {style: game_name}, 
	                                        game.name
	                                    )
	                                )
	                            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var React = __webpack_require__(1);
	var SmallTwitchComponents = __webpack_require__(167)
	
	var ListViewTwitchStreams = React.createClass({displayName: "ListViewTwitchStreams",
	            ...
	            if (this.props.data.streams) {
	                ...
	                listView = this.props.data.streams.map(function(stream, i) {
	                    return (
	                        React.createElement("tbody", {style: tbody, key: i}, 
	                            React.createElement("tr", null, 
	                                React.createElement("td", {style: logo, rowSpan: "3"}, 
	                                    React.createElement("a", {href: "/#/!/?streamer="+stream.channel.name, 
	                                        onClick: this.props.setChannel.bind(null, stream.channel.name)}, 
	                                        React.createElement(SmallTwitchComponents.TwitchUserLogo, {
	                                            style: image, 
	                                            src: stream.channel.logo}
	                                            )
	                                    )
	                                ), 
	                                React.createElement("td", {style: name}, stream.channel.name), 
	                                React.createElement("td", {style: viewers}, stream.viewers)
	                            ), 
	                            React.createElement("tr", null, 
	                                React.createElement("td", {style: game}, stream.game)
	                            ), 
	                            React.createElement("tr", null, 
	                                React.createElement("td", {style: status}, stream.channel.status)
	                ...
	                listView = array.map(function(stream, i) {
	                    return (
	                        React.createElement("tbody", {style: tbody, key: i}, 
	                            React.createElement("tr", null, 
	                                React.createElement("td", {style: logo, rowSpan: "3"}, 
	                                    React.createElement("a", {href: window.location.href  + '/#/!/?streamer='+stream.display_name, 
	                                ...
	                                React.createElement("td", {style: name}, stream.display_name), 
	                                React.createElement("td", {style: viewers}, stream.current_viewers)
	                            ), 
	                            React.createElement("tr", null, 
	                                React.createElement("td", {style: game}, stream.meta_game)
	                            ), 
	                            React.createElement("tr", null, 
	                                React.createElement("td", {style: status}, stream.title)
	                            )
	                        )
	                    );
	                }.bind(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TwitchUserLogo = React.createClass({displayName: "TwitchUserLogo",
	    ...
	    render: function () {
	        // CSS inline styles
	        if (this.props.src) {
	            return React.createElement("img", {style: this.props.style, src: this.props.src});
	        }
	
	        return React.createElement("img", {style: this.props.style, src: this.default_src});
	    }
	
	});
	
	var TwitchGameLogo = React.createClass({displayName: "TwitchGameLogo",
	    ...
	    render: function () {
	        ...
	        if (this.props.src) {
	            return React.createElement("img", {style: preview, src: this.props.src});
	        }
	
	        return React.createElement("img", {style: preview, src: this.default_src});
	    }
	
	});
	
	var HoverGamePreview = React.createClass({displayName: "HoverGamePreview",
	    default_src: 'https://s.jtvnw.net/jtv_user_pictures/hosted_images/GlitchIcon_WhiteonPurple.png',
	    ...
	    render: function() {
	        ...
	        if (this.props.game_logo) {
	            return (
	                React.createElement("div", {style: hover}, 
	                    React.createElement(TwitchGameLogo, {src: this.props.game_logo})
	                )
	        ...
	        return (
	            React.createElement(TwitchGameLogo, null)
	        );
	    }
	});
	
	
	var HoverStreamPreview = React.createClass({displayName: "HoverStreamPreview",
	            ...
	            if (this.props.stream.channel.logo) {
	                return (
	                    React.createElement("div", {style: div}, 
	                        React.createElement(TwitchStreamPreviewImg, {src: this.props.stream.preview.medium})
	                    )
	                );
	            }
	            return (
	                React.createElement("div", {style: div}, 
	                    React.createElement(TwitchStreamPreviewImg, null)
	                )
	            );
	        }
	...
	var TwitchStreamPreviewImg = React.createClass({displayName: "TwitchStreamPreviewImg",
	...
	module.exports = {
	    TwitchUserLogo:TwitchUserLogo,
	    TwitchGameLogo:TwitchGameLogo,
	    HoverGamePreview:HoverGamePreview,
	    HoverStreamPreview:HoverStreamPreview,
	    TwitchStreamPreviewImg:TwitchStreamPreviewImg,
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TwitchVideoPlayer = React.createClass({displayName: "TwitchVideoPlayer",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TwitchChat = React.createClass({displayName: "TwitchChat",
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("div", {style: div}, 
	                React.createElement("div", {style: flex_div}, 
	                    React.createElement("p", {style: error}, "No stream has been loaded."), 
	                    React.createElement("button", {style: button, onClick: this.loadChat}, "Load chat for ", this.state.channel)
	                )
	            )
	        );
